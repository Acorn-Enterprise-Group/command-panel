export type CommandLevel = 'safe' | 'caution' | 'danger';
export type CommandPlatform = 'windows' | 'mac' | 'linux' | 'any';
    ...
    items: [
      {
        ...
        shellLabel: 'Node',
        level: 'safe',
        whenToUse: 'Use this if a tool requires a certain Node version.',
