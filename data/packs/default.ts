      ...
      "items": [
        {
          ...
          "expectedResult": "You will see a list of packages installed and the command ends without errors.",
          "ifItFails": [
        ...
        },
        {
          ...
          "expectedResult": "You will see a message that the server is running, usually on port 3000.",
          "ifItFails": [
            "Run npm install first.",
            "If the port is busy, see Fix Common Errors for port help.",
            "If you are still stuck, ask for help and share the exact error."
          ],
          "tags": [
            "dev"
          ],
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "expectedResult": "The lock file is removed and will be recreated on install.",
          "ifItFails": [
    ...
    },
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "expectedResult": "git status will show files under Changes to be committed.",
          "ifItFails": [
            "Check file permissions.",
  ...
  "recipes": [
    {
      ...
      "intro": "Use this the very first time you open the project. It installs packages, starts the server, and opens the site.",
      "steps": [
        {
          "id": "first-time-setup-step-1",
          "type": "command",
          "commandId": "start-install"
        },
        {
          "id": "first-time-setup-step-2",
          "type": "command",
          "commandId": "start-dev"
        },
        {
    ...
    },
    {
      ...
      "intro": "This usually means the packages are not installed. This flow installs them and starts the server.",
      "steps": [
        {
          "id": "fix-next-step-1",
          "type": "command",
          "commandId": "fix-next-not-found"
        },
        {
          "id": "fix-next-step-2",
          "type": "command",
    ...
    },
    {
      ...
      "intro": "This helps you find what is using port 3000 and stop it, then start the server again.",
      "steps": [
        {
          "id": "fix-port-step-1",
          "type": "command",
          "commandId": "fix-port-find-3000"
        },
        {
          "id": "fix-port-step-2",
          "type": "command",
          "commandId": "fix-port-kill"
        },
        {
          "id": "fix-port-step-3",
          "type": "command",
    ...
    },
    {
      ...
      "intro": "Use this when installs feel broken but you do not want to delete your work.",
      "steps": [
        {
          "id": "reset-safe-step-1",
          "type": "command",
          "commandId": "reset-git-status"
        },
        {
          "id": "reset-safe-step-2",
          "type": "command",
          "commandId": "reset-next-cache"
        },
        {
          "id": "reset-safe-step-3",
          "type": "command",
          "commandId": "reset-npm-install"
        }
      ],
      "platform": "windows"
    },
    {
      ...
      "steps": [
        {
          "id": "prisma-studio-step-1",
          "type": "command",
          "commandId": "prisma-studio"
        }
      ],
      "platform": "any"
    },
    {
      ...
      "intro": "Use this when you want to build and run the production version locally.",
      "steps": [
        {
          "id": "build-prod-step-1",
          "type": "command",
          "commandId": "start-build"
        },
        {
          "id": "build-prod-step-2",
          "type": "command",
